...
const VERSION='v4-auto-sync-001';
function showErr(e){errBox.style.display='block';errBox.textContent='Lỗi nạp: '+(e?.message||e);console.error(e);}
async function boot(){try{
  ...
  async function render(tab){tabs.forEach(b=>b.classList.toggle('active',b.dataset.tab===tab));app.innerHTML='Đang nạp...';app.innerHTML=await loaders[tab]();}
